...
exports.TowTruckTypeUpdateDto = exports.TowTruckTypeCreateDto = void 0;
var class_validator_1 = require("class-validator");
var TowTruckTypeCreateDto = function () {
    var _a;
    ...
    return _a = /** @class */ (function () {
            function TowTruckTypeCreateDto() {
            ...
            return TowTruckTypeCreateDto;
        }()),
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _name_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)()];
            _baseFare_decorators = [(0, class_validator_1.IsNumber)(), (0, class_validator_1.IsNotEmpty)()];
            _costPerKm_decorators = [(0, class_validator_1.IsNumber)(), (0, class_validator_1.IsNotEmpty)()];
...
exports.TowTruckTypeCreateDto = TowTruckTypeCreateDto;
var TowTruckTypeUpdateDto = function () {
    var _a;
    var _instanceExtraInitializers = [];
    var _name_decorators;
    var _name_initializers = [];
    ...
    var _dateUpdated_initializers = [];
    return _a = /** @class */ (function () {
            function TowTruckTypeUpdateDto() {
                this.name = (__runInitializers(this, _instanceExtraInitializers), __runInitializers(this, _name_initializers, void 0));
                this.baseFare = __runInitializers(this, _baseFare_initializers, void 0);
                this.costPerKm = __runInitializers(this, _costPerKm_initializers, void 0);
                this.dateCreated = __runInitializers(this, _dateCreated_initializers, void 0);
            ...
            return TowTruckTypeUpdateDto;
        }()),
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _name_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsOptional)()];
            _baseFare_decorators = [(0, class_validator_1.IsNumber)(), (0, class_validator_1.IsOptional)()];
            _costPerKm_decorators = [(0, class_validator_1.IsNumber)(), (0, class_validator_1.IsOptional)()];
            _dateCreated_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsOptional)()];
            _dateDeleted_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsOptional)()];
            _dateUpdated_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsOptional)()];
            __esDecorate(null, null, _name_decorators, { kind: "field", name: "name", static: false, private: false, access: { has: function (obj) { return "name" in obj; }, get: function (obj) { return obj.name; }, set: function (obj, value) { obj.name = value; } }, metadata: _metadata }, _name_initializers, _instanceExtraInitializers);
...
exports.TowTruckTypeUpdateDto = TowTruckTypeUpdateDto;
