...
var Event = function () {
    ...
    (function () {
        ...
        _eventTimestamp_decorators = [(0, typeorm_1.Column)({})];
        _userId_decorators = [(0, typeorm_1.Column)({})];
        _user_decorators = [(0, typeorm_1.ManyToOne)(function () { return domain_1.User; }, function (parent) { return parent.events; }), (0, typeorm_1.JoinColumn)({ name: 'userId' })];
