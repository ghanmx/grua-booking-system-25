...
var NotificationPreference = function () {
    ...
    var NotificationPreference = _classThis = /** @class */ (function () {
        function NotificationPreference_1() {
            ...
            this.preference = __runInitializers(this, _preference_initializers, void 0);
    ...
    (function () {
        ...
        _preference_decorators = [(0, typeorm_1.Column)()];
        _userId_decorators = [(0, typeorm_1.Column)()];
        _user_decorators = [(0, typeorm_1.ManyToOne)(function () { return domain_1.User; }, function (parent) { return parent.notificationPreferences; }), (0, typeorm_1.JoinColumn)({ name: 'userId' })];
