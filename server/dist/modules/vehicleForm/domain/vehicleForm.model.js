...
var VehicleForm = function () {
    ...
    var VehicleForm = _classThis = /** @class */ (function () {
        function VehicleForm_1() {
            this.id = (__runInitializers(this, _instanceExtraInitializers), __runInitializers(this, _id_initializers, void 0));
            this.vehicleId = __runInitializers(this, _vehicleId_initializers, void 0);
            this.vehicle = __runInitializers(this, _vehicle_initializers, void 0);
        ...
        return VehicleForm_1;
    }());
    __setFunctionName(_classThis, "VehicleForm");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _id_decorators = [(0, typeorm_1.PrimaryGeneratedColumn)('uuid')];
        _vehicleId_decorators = [(0, typeorm_1.Column)({})];
        _vehicle_decorators = [(0, typeorm_1.ManyToOne)(function () { return domain_1.TowServiceRequest; }, function (parent) { return parent.vehicleFormsAsVehicle; }), (0, typeorm_1.JoinColumn)({ name: 'vehicleId' })];
        ...
        __esDecorate(null, null, _vehicle_decorators, { kind: "field", name: "vehicle", static: false, private: false, access: { has: function (obj) { return "vehicle" in obj; }, get: function (obj) { return obj.vehicle; }, set: function (obj, value) { obj.vehicle = value; } }, metadata: _metadata }, _vehicle_initializers, _instanceExtraInitializers);
        ...
        VehicleForm = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return VehicleForm = _classThis;
}();
