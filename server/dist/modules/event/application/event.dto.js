...
exports.EventUpdateDto = exports.EventCreateDto = void 0;
var class_validator_1 = require("class-validator");
var EventCreateDto = function () {
    var _a;
    var _instanceExtraInitializers = [];
    var _eventType_decorators;
    var _eventType_initializers = [];
    var _eventTimestamp_decorators;
    var _eventTimestamp_initializers = [];
    ...
    return _a = /** @class */ (function () {
            function EventCreateDto() {
                this.eventType = (__runInitializers(this, _instanceExtraInitializers), __runInitializers(this, _eventType_initializers, void 0));
                this.eventTimestamp = __runInitializers(this, _eventTimestamp_initializers, void 0);
        ...
        (function () {
            ...
            _eventType_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)()];
            _eventTimestamp_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)()];
            ...
            __esDecorate(null, null, _eventType_decorators, { kind: "field", name: "eventType", static: false, private: false, access: { has: function (obj) { return "eventType" in obj; }, get: function (obj) { return obj.eventType; }, set: function (obj, value) { obj.eventType = value; } }, metadata: _metadata }, _eventType_initializers, _instanceExtraInitializers);
            __esDecorate(null, null, _eventTimestamp_decorators, { kind: "field", name: "eventTimestamp", static: false, private: false, access: { has: function (obj) { return "eventTimestamp" in obj; }, get: function (obj) { return obj.eventTimestamp; }, set: function (obj, value) { obj.eventTimestamp = value; } }, metadata: _metadata }, _eventTimestamp_initializers, _instanceExtraInitializers);
...
var EventUpdateDto = function () {
    ...
    return _a = /** @class */ (function () {
        ...
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _eventType_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsOptional)()];
            _eventTimestamp_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsOptional)()];
            _dateCreated_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsOptional)()];
            _dateDeleted_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsOptional)()];
            _dateUpdated_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsOptional)()];
            _userId_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsOptional)()];
