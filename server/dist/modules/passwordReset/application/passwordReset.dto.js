...
exports.PasswordResetUpdateDto = exports.PasswordResetCreateDto = void 0;
var class_validator_1 = require("class-validator");
var PasswordResetCreateDto = function () {
    var _a;
    ...
    return _a = /** @class */ (function () {
            function PasswordResetCreateDto() {
            ...
            return PasswordResetCreateDto;
        }()),
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _token_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)()];
            _expirationDate_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)()];
...
exports.PasswordResetCreateDto = PasswordResetCreateDto;
var PasswordResetUpdateDto = function () {
    var _a;
    var _instanceExtraInitializers = [];
    var _token_decorators;
    var _token_initializers = [];
    ...
    var _userId_initializers = [];
    return _a = /** @class */ (function () {
            function PasswordResetUpdateDto() {
                this.token = (__runInitializers(this, _instanceExtraInitializers), __runInitializers(this, _token_initializers, void 0));
                this.expirationDate = __runInitializers(this, _expirationDate_initializers, void 0);
                this.dateCreated = __runInitializers(this, _dateCreated_initializers, void 0);
                this.dateDeleted = __runInitializers(this, _dateDeleted_initializers, void 0);
            ...
            return PasswordResetUpdateDto;
        }()),
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _token_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsOptional)()];
            _expirationDate_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsOptional)()];
            _dateCreated_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsOptional)()];
            _dateDeleted_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsOptional)()];
            _dateUpdated_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsOptional)()];
            _userId_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsOptional)()];
...
exports.PasswordResetUpdateDto = PasswordResetUpdateDto;
